...
st.caption("💬 Language set to " + lang + "  🎯 Recommendations focusing on " + selected_crop + " for " + state)
...
if prompt := st.chat_input("Ask me anything!"):
    ...
    system_message = f"You are an AgroNeubot created ny NeuBiom Labs, here to help with information and context-specific recommendations for farming in {state} for the following query and user is particularly interested in cultivation of {selected_crop}. If you don't know something just say that you don't have the information and strictly never answer questions unrelated to agriculture."
